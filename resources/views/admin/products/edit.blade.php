        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <ul class="nav nav-tabs" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="seotage-tab" data-bs-toggle="tab" data-bs-target="#seotage-tab-pane" type="button" role="tab" aria-controls="seotage-tab-pane" aria-selected="false">
                            SEO Tags
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-content" id="myTabContent">
                        <div class="tab-pane border p-3 show active" id="home-tab-pane" role="tabpanel" aria-labelledby="home-tab" tabindex="0">
                            <div class="mb3">
                        ...
                        <div class="tab-pane fade border p-3" id="seotage-tab-pane" role="tabpanel" aria-labelledby="seotage-tab" tabindex="0">
                            <div class="mb-3">
                        ...
                        <div class="tab-pane fade border p-3" id="image-tab-pane" role="tabpanel" aria-labelledby="image-tab" tabindex="0">
                            ...
                            <div class="row">
                                ...
                                <img src="{{ asset($image->image) }}" style="width: 80px;height: 80px;"
                                    class="me-4 border border-dark " alt="img" />
                                        ...
                                        <tr class="prod-color-tr">
                                            ...
                                            <td>
                                                <div class="input-group mb-3" style="width:150px" >
                                                    <input type="text" value="{{ $prodColor->quantity }}" class="productColorQuantity form-control form-control-sm" style="width:65px;">
