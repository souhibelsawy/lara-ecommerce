...
<script src="https://www.paypal.com/sdk/js?client-id=AT9OEOzFQ1XBnNwFeR6viW-yJPQch-ialh6IwzmBMI9dZ3MjarMNpl8MJZSLbF1m_iTBtc18cgcohXUN&currency=USD"></script>
<script>
  paypal.Buttons({
    ...
    onApprove: (data, actions) => {
        return actions.order.capture().then(function(orderData) {
            ...
            if(transaction.status == "COMPLETED"){
                Livewire.emit('transactionEmit', trancation.id);
            }
